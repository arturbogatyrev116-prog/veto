...
<div class="overlay" role="dialog" aria-modal="true" aria-labelledby="chat-stats-title" on:click|self={() => dispatch('close')}>
  <div class="modal">
    <div class="modal-header">
      <span class="modal-title" id="chat-stats-title">📊 Chat Statistics</span>
